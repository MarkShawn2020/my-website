...
const pluginRehypeCrossrefReformat = () => (hast) => (0, unist_util_visit_1.default)(hast, 'element', handleGrandFatherOfFooterRef);
exports.default = pluginRehypeCrossrefReformat;
